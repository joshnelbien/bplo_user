...
const TableRatingRow = ({ criteria, id, selectedRating, onSelect, isLast = false }) => (
  <Box
    sx={{
      display: 'flex',
      minHeight: '2.5rem',
...
const RatingTable = ({ title, items, ratings, setRatings, isLastTable = false }) => {
...
export default function ClientFeedbackForm() {
  ...
  const clientFields = [
    { label: 'Name of Client/Pangalan ng kliyente (Optional)', id: 'clientName' },
    ...
    { label: 'Name of Employee/Pangalan ng Empleyado (Optional)', id: 'employeeName' },
  ...
  const qualityOfServiceItems = [
    ...
    { id: 'q3', criteria: 'Knowledge and Ability/Kaalaman at kakayahan sa Pagbibigay Serbisyo' },
  ];
    ...
    <Box sx={{ maxWidth: '900px', mx: 'auto', p: 1 }}>
      ...
      >
        ...
        >
          ...
          />
          <Box sx={{ textAlign: 'center', lineHeight: 1.1, flexGrow: 1, mx: 1 }}>
            ...
            <Typography variant="caption" sx={{ display: 'block', mb: 0.2, fontSize: '0.6rem' }}>
        ...
        {/* 4. Instructions - Kept */}
        <Box sx={{ mb: 1 }}>
          <Typography variant="caption" component="p" sx={{ fontSize: '0.7rem', fontWeight: 'bold' }}>
            Please put a check on the box to your answer./Mangyaring pindutin ang box ang inyong sagot.
          </Typography>
          <Typography variant="caption" component="p" sx={{ fontSize: '0.7rem' }}>
            Ratings (shown above each box): 5 - Excellent, 4 - Very Satisfactory, 3 - Satisfactory, 2 - Unsatisfactory, 1 - Poor
          </Typography>
        </Box>
        ...
        <Box sx={{ borderTop: '2px solid red', pt: 0.5 }}>
          <Typography variant="caption" lineHeight={1.2} sx={{ fontSize: '0.6rem' }}>
            Important Reminder: The contents shall be kept confidential and shall be for internal
            use/evaluation
            <span>
              only. Mahalagang Paalala: Ang nilalaman ng kasulatang ito ay pananatilihing lihim o
              gagamitin
            </span>
            <span>
              &nbsp;tanging ng kinauukulan sa pagsukalo paglilimbag ng serbisyong natanggap.
            </span>
          </Typography>
        </Box>

        {/* 9. Footer - Kept */}
        <Typography variant="caption" sx={{ mt: 0.5, display: 'block', fontSize: '0.6rem' }}>
