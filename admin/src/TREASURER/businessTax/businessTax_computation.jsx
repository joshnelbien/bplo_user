...
// 2. Updated Header Component: Removed Bagong Pilipinas and Permit Number sections
const PermitHeader = () => (
  <Box sx={{ mb: 4, textAlign: "center" }}>
    <Grid
      ...
      sx={{ borderBottom: "2px solid black", pb: 1, mb: 2 }}
    >
      {/* City of San Pablo Logo and Office Text - CENTER ONLY */}
      <Grid item xs={12} sx={{ textAlign: "center" }}>
        <img src={spcLogo} alt="City of San Pablo" style={{ height: "80px" }} />
        <Typography
          variant="subtitle1"
          fontWeight="bold"
...
function BusinessTax_computation({ isOpen, onClose, applicant }) {
  ...
  // Permit number is no longer displayed, but we keep the logic for docx export if needed
  const permitNumber = applicant?.PermitNumber || "00000";
  ...
  return (
    <Dialog open={isOpen} onClose={onClose} fullWidth maxWidth="md">
      ...
      <DialogContent dividers>
        ...
        <Box p={2} sx={{ border: "2px solid darkgreen" }}>
          {/* 3. Insert the new Header component here */}
          <PermitHeader /> {/* Removed permitNumber prop */}
          {/* End of Header */}
          {/* Reference */}
